...
import com.kyd.service.PermitHandleService;
...
@RestController
@RequestMapping("permitHandle")
@Api(value = "权限操作表")
public class PermitHandleBiz extends AbstractBiz<PermitHandleService> implements BaseBiz<PermitHandleService> {
