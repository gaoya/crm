...
@RequestMapping("log")
@Api(value = "日志表")
public class LogBiz extends AbstractBiz<LogService> implements BaseBiz<LogService> {
    ...
    @ApiImplicitParams({
            ...
            @ApiImplicitParam(name = "operId", value = "操作人编号"),
            @ApiImplicitParam(name = "operName", value = "操作人姓名"),
